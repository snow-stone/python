...
#    import copy
    ...
    l = \
        tsR.pre_check(ps.parameters,"Dai_lines_typeFace_cell-3")
...
#==============================================================================
    ...
    ax1.plot(outerCoordData['rByD'],outerCoordData['mean'],label='mean',linewidth=2)
...
#        print outerCoordData['dataCmptArray'][i]
