...
#    import copy
    ...
    l = tsR.pre_check(ps.parameters,"Dai_lines_typeFace_cell-1")
...
#    ax2.plot(outerCoordData['rByD'],outerCoordData['std'],label='mapped',linewidth=2)
    ...
    l = tsR.pre_check(ps_synthetic.parameters,"Dai_lines_typeFace_cell-1")
...
#        ax2.plot(outerCoordData['rByD'],outerCoordData['chunkedStd'][i],label=str(i),linewidth=2)
    ...
    ax1.set_title('time stat. @'+r'$-4mm$'+' cut')
