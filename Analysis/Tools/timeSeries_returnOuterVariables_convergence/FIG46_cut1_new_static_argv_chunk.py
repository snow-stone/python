...
#   get data    
    ...
    fileListSimu1 = tsR.pre_check(simu_parameters1,"Dai_lines_typeFace_cell-1")
    dataBase2Plot1 = tsR.process(simu_parameters1,validDataList=fileListSimu1,colonNb=1)  

    simu_parameters2['sampling']['dataShape']=simu_parameters2['sampling']['dataShape1']
    fileListSimu2 = tsR.pre_check(simu_parameters2,"Dai_lines_typeFace_cell-1")
    dataBase2Plot2 = tsR.process(simu_parameters2,validDataList=fileListSimu2,colonNb=1)  
...
#   plot settings    
    ...
    ax3.set_ylabel(r'$Error_{U,mean}$')
    ax3.set_ylim(0,1)
    ...
    ax3_new.imshow(im)
    ax3_new.axis('off')
    ax3.legend(bbox_to_anchor=(1, 1.4))
    ax4_new = fig4.add_axes(rect, anchor='NE', zorder=-1)
    ax4_new.imshow(im)
    ax4_new.axis('off')
    ax4.legend(bbox_to_anchor=(1, 1.4))
