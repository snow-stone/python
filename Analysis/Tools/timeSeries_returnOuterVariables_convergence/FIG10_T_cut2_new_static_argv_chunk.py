...
#   get data    
    simu_parameters1['sampling']['dataShape']=simu_parameters1['sampling']['TdataShape2']
    ...
    simu_parameters2['sampling']['dataShape']=simu_parameters2['sampling']['TdataShape2']
...
#   plot settings    
    ...
    ax3.plot(mean_diff1, marker='o',label=alias_dict[parameterFileBasename1],linestyle='--',markerfacecolor='none',markersize=8)
    ax3.plot(mean_diff2, marker='<',label=alias_dict[parameterFileBasename2],linestyle='-.',markerfacecolor='none',markersize=8)
    ax3.set_xlabel(r'$N_i$')
    ax3.set_ylabel(r'$Error_{c,mean}$')
    ax3.set_ylim(0,1.2)
    ax4.plot(rms_diff1, marker='o',label=alias_dict[parameterFileBasename1],linestyle='--',markerfacecolor='none',markersize=8)
    ax4.plot(rms_diff2, marker='<',label=alias_dict[parameterFileBasename2],linestyle='-.',markerfacecolor='none',markersize=8)
    ax4.set_xlabel(r'$N_i$')
    ax4.set_ylabel(r'$Error_{c,rms}$')
    ax4.set_ylim(0,1.2)
    ...
    ax4_new = fig4.add_axes(rect, anchor='NE', zorder=-1)
    ax4_new.imshow(im)
    ax4_new.axis('off')
    fig3.savefig(saveDir+"T_cut2a_error.png",  bbox_inches='tight')
    fig4.savefig(saveDir+"T_cut2b_error.png",  bbox_inches='tight')
