...
#    fig2.savefig("./"+"cut2_abcde_3_fig2.png",  bbox_inches='tight')
    ...
    fig3.savefig(saveDir+"cut2_abcde_3_new_profil2a.png",  bbox_inches='tight')
    ...
    fig4.savefig(saveDir+"cut2_abcde_3_new_profil2b.png",  bbox_inches='tight')
    ...
    ax3.set_xlabel(r'$r/D$')
    ax3.set_ylabel(r'$\frac{\overline{\bf{u}_x}}{\bf{u}_{bulk}}$')
    fig3.savefig(saveDir+"cut2_abcde_3_new_profil3a.png",  bbox_inches='tight')
    ...
    ax4.set_xlabel(r'$r/D$')
    ax4.set_ylabel(r'$\frac{rms(\bf{u}_x)}{\bf{u}_{bulk}}$')
    fig4.savefig(saveDir+"cut2_abcde_3_new_profil3b.png",  bbox_inches='tight')
