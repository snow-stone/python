...
#    db_1b_syn = tsR.process(ps_syn.parameters,validDataList=l_1b_syn,colonNb=1)
    ...
    ps_map.parameters['sampling']['dataShape']=(332,4)    
...
#    db_1d_map2e3 = tsR.process(ps_map.parameters,validDataList=l_1d_map2e3,colonNb=1)
    ...
    ps_map.parameters['sampling']['dataShape']=(321,4)    
...
#    fig2.savefig("./"+"cut2_abcde_3_fig2.png",  bbox_inches='tight')
    ...
    ax3.plot(db_1d_map2['rByD'],db_1d_map2['mean']/Ux_bulk_Dai,label='1dlR2-mapped',linewidth=4, color='steelblue')
    x1,y1 = rdb.Dai_thesis.Fig4p9a('EAU')
    ...
    # For cut 3
    fig3,ax3 = plt.subplots()
    ax3.plot(db_1d_map3['rByD'],db_1d_map3['mean']/Ux_bulk_Dai,label='1dlR2-mapped',linewidth=4, color='steelblue')
