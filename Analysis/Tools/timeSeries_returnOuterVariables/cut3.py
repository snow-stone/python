...
#   get data
    l_1b_syn = tsR.pre_check(ps_syn.parameters,"Dai_lines_typeFace_cell-3")
    db_1b_syn = tsR.process(ps_syn.parameters,validDataList=l_1b_syn,colonNb=1)

    l_1d_map = tsR.pre_check(ps_map.parameters,"Dai_lines_typeFace_cell-3")
...
#   plot settings
    ...
    ax1.set_title('time stat. @'+r'$+3.625D$'+' cut')
