...
#   get data    
    simu_parameters1['sampling']['dataShape']=simu_parameters1['sampling']['nudataShape5']
    fileListSimu = tsR.pre_check(simu_parameters1,"nu_mesh_lines_typeFace_cell-5")
    dataBase2Plot1 = tsR.process(simu_parameters1,validDataList=fileListSimu,colonNb=1)  

    simu_parameters2['sampling']['dataShape']=simu_parameters2['sampling']['nudataShape5']
    fileListSimu = tsR.pre_check(simu_parameters2,"nu_mesh_lines_typeFace_cell-5")
...
#    ax1.set_ylim(-0.5,4)
    ...
    fig1.savefig(saveDir+"cut5a_nu.png",  bbox_inches='tight')
    fig2.savefig(saveDir+"cut5b_nu.png",  bbox_inches='tight')
