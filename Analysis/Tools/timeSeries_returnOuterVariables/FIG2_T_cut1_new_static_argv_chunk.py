...
#   get data    
    ...
    fileListSimu = tsR.pre_check(simu_parameters,"Dai_lines_typeFace_cell_T-1")
...
#   plot settings    
    ...
    fig1.savefig(saveDir+"T_cut1a.png",  bbox_inches='tight')
    fig2.savefig(saveDir+"T_cut1b.png",  bbox_inches='tight')
