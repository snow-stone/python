...
def main():
    ...
    import parameters_T_RES1b_MethodSynthetic as ps_synthetic
    import parameters_T_RES1d_MethodMapped_subMethod_NearestFace as ps
#    import copy
    
    fig1,ax1 = plt.subplots()
    fig2,ax2 = plt.subplots()
    
    l = tsR.pre_check(ps.parameters,"Dai_lines_typeFace_cell-3")
...
#    ax2.plot(outerCoordData['rByD'],outerCoordData['chunkedStd'][-1],label='mapped last chunk stat.',linewidth=2)
    ...
    l = tsR.pre_check(ps_synthetic.parameters,"Dai_lines_typeFace_cell-3")
    ...
    ax1.set_title('time stat. @'+r'$33mm$'+' cut')
