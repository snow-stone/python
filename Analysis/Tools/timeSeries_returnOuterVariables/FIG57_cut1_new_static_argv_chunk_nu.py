...
#   get data    
    simu_parameters1['sampling']['dataShape']=simu_parameters1['sampling']['nudataShape1']
    fileListSimu = tsR.pre_check(simu_parameters1,"nu_mesh_lines_typeFace_cell-1")
    dataBase2Plot1 = tsR.process(simu_parameters1,validDataList=fileListSimu,colonNb=1)  

    simu_parameters2['sampling']['dataShape']=simu_parameters2['sampling']['nudataShape1']
    fileListSimu = tsR.pre_check(simu_parameters2,"nu_mesh_lines_typeFace_cell-1")
...
#    ax1.set_ylim(-0.5,4)
    ...
    fig1.savefig(saveDir+"cut1a_nu.png",  bbox_inches='tight')
    fig2.savefig(saveDir+"cut1b_nu.png",  bbox_inches='tight')
