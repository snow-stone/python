...
#            ]
    ...
    for i, sample in enumerate(samples):
        ...
        fig.savefig("../PICTURE_history_forcing/"+arrayName+"/x_Eq_"+str(positionList[sample]/8.0).replace('.','p')+"D.png", bbox_inches='tight',dpi=300) # bbox_inches = 'tight' is neccessary
#==============================================================================
#   RMS 
#==============================================================================    
    fig_rms = plt.figure()
...
#    ax1.set_ylim(0,0.4)
    ...
    fig_rms.savefig('../PICTURE_history_forcing/'+arrayName+'/RMS_xByD_oneFig.png', bbox_inches='tight',  dpi=300)
#==============================================================================
#   Mean
#==============================================================================
    fig_rms = plt.figure()
...
#    ax2 = fig_rms.add_subplot(2,1,2)
    ...
    fig_rms.savefig('../PICTURE_history_forcing/'+arrayName+'/Mean_xByD_oneFig.png', bbox_inches='tight', dpi=300)
