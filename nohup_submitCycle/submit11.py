...
def RunJobs(pickUpFromJobNb, nb_jobs, physical_time_interval, endTimeWall):
    import controlDict4Continue6c as controlDict_editor

    print "Start RunJobs =================\n"
    notYetEndTimeWall = True
    currentJobNb = pickUpFromJobNb + 1
...
RunJobs(pickUpFromJobNb=1,nb_jobs=300,physical_time_interval=0.001,endTimeWall=0.3) #TODO read from file per-job so that this is runtime modifiable
