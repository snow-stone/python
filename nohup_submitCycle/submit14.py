...
def RunJobs(pickUpFromJob, nb_jobs, physical_time_interval, endTimeWall):
    ...
    for i in range(nb_jobs):
        ...
        if ifHittingWall == 0 or ifHittingWall == 1:
            ...
            returnFromCurrentJob = tryJob(i+currentJobNb, queue)
...
RunJobs(pickUpFromJob=0,nb_jobs=152,physical_time_interval=0.001,endTimeWall=0.451) #TODO read from file per-job so that this is runtime modifiable
