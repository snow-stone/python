...
#    simLogFile = 'logSimulation0.core480'
    ...
    slurmFile   = queue
    if queue == 'hsw' :                                #TODO add option newtonian or BC... mpirun or srun
        with open(slurmFile,'w') as sf:
            sf.write("#!/bin/bash\n")
            sf.write("#SBATCH --job-name=OF3Stp\n")
...
RunJobs(pickUpFromJob=0,nb_jobs=152,physical_time_interval=0.001,endTimeWall=0.451, wallTimePerJob=60*60) #TODO read from file per-job so that this is runtime modifiable
