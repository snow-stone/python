...
def getProbeByLabel_forcing(caseName, path2Data, fieldName, sample, positions, color, cut=0.):
...
def getProbeByLabel(caseName, path2Data, fieldName, sample, positions, color, cut=0.5):
    RelativeDataFile = "./"+"userDefinedLog/history_labelGroup_"+fieldName
    rawData = np.genfromtxt(path2Data+"/"+caseName+'/'+RelativeDataFile)
#    print rawData.shape
    time = rawData[:,0]
...
#                    print "There's a big problem"
                ...
                if j == 0:
                    data = getProbeByLabel(case, path2Data, fieldName, p, allProbePosition, colorList[i], cut=0.6)

#                if j == 7 :
#                    data = getProbeByLabel(case, path2Data, fieldName, p, allProbePosition, colorList[i], cut=0.5)
...
#        fig.savefig(path2Data+"/"+"PICTURE_history_FFT/"+"8simu/"+str(allProbePosition[p]/8.0)+"D.png", bbox_inches='tight') # bbox_inches = 'tight' is neccessary
