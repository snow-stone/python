...
#    mean3 = np.zeros(len(positionList))
    ...
    #    print "\nFig"
        ...
        std0[i], mean[i][0] = userProbeByLabel(ax1, case1, dataFile, sample, positionList, cut=400)
#        userProbeByLabel(ax1, case1, dataFile, sample, positionList, cut=400)
        case2 = "Newtonian"+"/"+"Re4000"
        std1[i], mean[i][1] = userProbeByLabel(ax1, case2, dataFile, sample, positionList, cut=400)
#        userProbeByLabel(ax1, case2, dataFile, sample, positionList, cut=400)
    ...
    #    print "\nFig1"
        ...
        std2[i], mean[i][2] = userProbeByLabel(ax2, case1, dataFile, sample, positionList, cut=0)
#        userProbeByLabel(ax2, case1, dataFile, sample, positionList, cut=0)
        case2 = "Newtonian"+"/"+"Re2400"
        std3[i], mean[i][3] = userProbeByLabel(ax2, case2, dataFile, sample, positionList, cut=400)
