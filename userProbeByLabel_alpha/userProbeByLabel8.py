...
#    print "\nFig"
    ...
    userProbeByLabel(ax1, case1, dataFile, samples, positionList, cut=400)
    case2 = "Newtonian"+"/"+"Re4000"
    userProbeByLabel(ax1, case2, dataFile, samples, positionList, cut=400)
...
#    print "\nFig1"
    ...
    userProbeByLabel(ax2, case1, dataFile, samples, positionList, cut=0)
    case2 = "Newtonian"+"/"+"Re2400"
    userProbeByLabel(ax2, case2, dataFile, samples, positionList, cut=400)
