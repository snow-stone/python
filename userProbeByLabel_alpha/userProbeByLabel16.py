...
#    ax2 = fig_rms.add_subplot(2,1,2)
    ...
    fig_rms.savefig('../PICTURE/'+arrayName+'/RMS_xByD_oneFig.png', bbox_inches='tight',  dpi=300)
#==============================================================================
#   Mean
#==============================================================================
    fig_rms = plt.figure()
...
#    ax2 = fig_rms.add_subplot(2,1,2)
    ...
    fig_rms.savefig('../PICTURE/'+arrayName+'/Mean_xByD_oneFig.png', bbox_inches='tight', dpi=300)
