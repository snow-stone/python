...
def plotCaseWithSlices(ax_cases, dataDir, positionList, cut):
    ...
    ax_cases.plot(positionList/8.0,meanOfRMS, label=dataDir)
...
def main():
    ...
    for caseDir in caseList:
        plotCaseWithSlices(ax_principle, caseDir, positionList, cut=0.7)
