...
def plotCaseWithSlices(ax_cases, path2Data, dataDir, positionList, marker, cut):
...
#              "Newtonian/Re2400"]
    ...
    for i, caseDir in enumerate(caseList):
        plotCaseWithSlices(ax_principle, path2Data, caseDir, positionList, markerList[i], cut=0.7)
