...
contourNu_y=nu_mean_slice_yNormal-logScale_clipped.py
...
Nu_x=nu_mean_slice_x_labels.py
contourT_x=T_mean_slice_x.py
T_x=T_mean_slice_x_labels.py
...
#pvpython $contourk_mean_nonD_y $BirdCarreau/inlet_0p5                 0.003 p3mm &&
#pvpython $contourk_mean_nonD_y $BirdCarreau/inlet0p5_impinging        0.003 p3mm &&
#pvpython $contourk_mean_nonD_y $BirdCarreau/inlet_0p3                 0.003 p3mm &&
#pvpython $contourk_mean_nonD_y $BirdCarreau/inlet_0p3-a_0p5-setT_St_1 0.003 p3mm &&
#pvpython $contourk_mean_nonD_y $BirdCarreau/inlet_0p3-a_0p5-setT_St_5 0.003 p3mm &&
#pvpython $contourk_mean_nonD_y $Newtonian/Re2400                      0.003 p3mm &&
#pvpython $contourk_mean_nonD_y $Newtonian/Re4000                      0.003 p3mm &&
#pvpython $contourk_mean_nonD_y $Newtonian/Re4000_impinging            0.003 p3mm &&
#echo "---------------" &&
#echo "Finish k_mean_nonD_y p3mm" &&
#echo "---------------" &&
#pvpython $contourk_mean_nonD_y $BirdCarreau/inlet_0p5                 0.002 p2mm &&
#pvpython $contourk_mean_nonD_y $BirdCarreau/inlet0p5_impinging        0.002 p2mm &&
#pvpython $contourk_mean_nonD_y $BirdCarreau/inlet_0p3                 0.002 p2mm &&
#pvpython $contourk_mean_nonD_y $BirdCarreau/inlet_0p3-a_0p5-setT_St_1 0.002 p2mm &&
#pvpython $contourk_mean_nonD_y $BirdCarreau/inlet_0p3-a_0p5-setT_St_5 0.002 p2mm &&
#pvpython $contourk_mean_nonD_y $Newtonian/Re2400                      0.002 p2mm &&
#pvpython $contourk_mean_nonD_y $Newtonian/Re4000                      0.002 p2mm &&
#pvpython $contourk_mean_nonD_y $Newtonian/Re4000_impinging            0.002 p2mm &&
#echo "---------------" &&
#echo "Finish k_mean_nonD_y p2mm" &&
#echo "---------------" &&
#pvpython $contourk_mean_nonD_y $BirdCarreau/inlet_0p5                 0.001 p1mm &&
#pvpython $contourk_mean_nonD_y $BirdCarreau/inlet0p5_impinging        0.001 p1mm &&
#pvpython $contourk_mean_nonD_y $BirdCarreau/inlet_0p3                 0.001 p1mm &&
#pvpython $contourk_mean_nonD_y $BirdCarreau/inlet_0p3-a_0p5-setT_St_1 0.001 p1mm &&
#pvpython $contourk_mean_nonD_y $BirdCarreau/inlet_0p3-a_0p5-setT_St_5 0.001 p1mm &&
#pvpython $contourk_mean_nonD_y $Newtonian/Re2400                      0.001 p1mm &&
#pvpython $contourk_mean_nonD_y $Newtonian/Re4000                      0.001 p1mm &&
#pvpython $contourk_mean_nonD_y $Newtonian/Re4000_impinging            0.001 p1mm &&
#echo "---------------" &&
#echo "Finish k_mean_nonD_y p1mm" &&
#echo "---------------" &&
#pvpython $contourk_mean_nonD_y $BirdCarreau/inlet_0p5                 0 0mm &&
#pvpython $contourk_mean_nonD_y $BirdCarreau/inlet0p5_impinging        0 0mm &&
#pvpython $contourk_mean_nonD_y $BirdCarreau/inlet_0p3                 0 0mm &&
#pvpython $contourk_mean_nonD_y $BirdCarreau/inlet_0p3-a_0p5-setT_St_1 0 0mm &&
#pvpython $contourk_mean_nonD_y $BirdCarreau/inlet_0p3-a_0p5-setT_St_5 0 0mm &&
#pvpython $contourk_mean_nonD_y $Newtonian/Re2400                      0 0mm &&
#pvpython $contourk_mean_nonD_y $Newtonian/Re4000                      0 0mm &&
#pvpython $contourk_mean_nonD_y $Newtonian/Re4000_impinging            0 0mm &&
#echo "---------------" &&
#echo "Finish k_mean_nonD_y 0mm" &&
#echo "---------------" &&
#pvpython $contourk_mean_nonD_y $BirdCarreau/inlet_0p5                 -0.003 n3mm &&
#pvpython $contourk_mean_nonD_y $BirdCarreau/inlet0p5_impinging        -0.003 n3mm &&
#pvpython $contourk_mean_nonD_y $BirdCarreau/inlet_0p3                 -0.003 n3mm &&
#pvpython $contourk_mean_nonD_y $BirdCarreau/inlet_0p3-a_0p5-setT_St_1 -0.003 n3mm &&
#pvpython $contourk_mean_nonD_y $BirdCarreau/inlet_0p3-a_0p5-setT_St_5 -0.003 n3mm &&
#pvpython $contourk_mean_nonD_y $Newtonian/Re2400                      -0.003 n3mm &&
#pvpython $contourk_mean_nonD_y $Newtonian/Re4000                      -0.003 n3mm &&
#pvpython $contourk_mean_nonD_y $Newtonian/Re4000_impinging            -0.003 n3mm &&
#echo "---------------" &&
#echo "Finish k_mean_nonD_y n3mm" &&
#echo "---------------" &&
#pvpython $contourk_mean_nonD_y $BirdCarreau/inlet_0p5                 -0.002 n2mm &&
#pvpython $contourk_mean_nonD_y $BirdCarreau/inlet0p5_impinging        -0.002 n2mm &&
#pvpython $contourk_mean_nonD_y $BirdCarreau/inlet_0p3                 -0.002 n2mm &&
#pvpython $contourk_mean_nonD_y $BirdCarreau/inlet_0p3-a_0p5-setT_St_1 -0.002 n2mm &&
#pvpython $contourk_mean_nonD_y $BirdCarreau/inlet_0p3-a_0p5-setT_St_5 -0.002 n2mm &&
#pvpython $contourk_mean_nonD_y $Newtonian/Re2400                      -0.002 n2mm &&
#pvpython $contourk_mean_nonD_y $Newtonian/Re4000                      -0.002 n2mm &&
#pvpython $contourk_mean_nonD_y $Newtonian/Re4000_impinging            -0.002 n2mm &&
#echo "---------------" &&
#echo "Finish k_mean_nonD_y n2mm" &&
#echo "---------------" &&
#pvpython $contourk_mean_nonD_y $BirdCarreau/inlet_0p5                 -0.001 n1mm &&
#pvpython $contourk_mean_nonD_y $BirdCarreau/inlet0p5_impinging        -0.001 n1mm &&
#pvpython $contourk_mean_nonD_y $BirdCarreau/inlet_0p3                 -0.001 n1mm &&
#pvpython $contourk_mean_nonD_y $BirdCarreau/inlet_0p3-a_0p5-setT_St_1 -0.001 n1mm &&
#pvpython $contourk_mean_nonD_y $BirdCarreau/inlet_0p3-a_0p5-setT_St_5 -0.001 n1mm &&
#pvpython $contourk_mean_nonD_y $Newtonian/Re2400                      -0.001 n1mm &&
#pvpython $contourk_mean_nonD_y $Newtonian/Re4000                      -0.001 n1mm &&
#pvpython $contourk_mean_nonD_y $Newtonian/Re4000_impinging            -0.001 n1mm &&
#echo "---------------" &&
#echo "Finish k_mean_nonD_y n1mm" &&
#echo "---------------" 
...
#pvpython $Q2 $BirdCarreau/inlet_0p5                 &&
#pvpython $Q2 $BirdCarreau/inlet0p5_impinging        &&
#pvpython $Q2 $BirdCarreau/inlet_0p3                 &&
#pvpython $Q2 $BirdCarreau/inlet_0p3-a_0p5-setT_St_1 &&
#pvpython $Q2 $BirdCarreau/inlet_0p3-a_0p5-setT_St_5 &&
#pvpython $Q2 $Newtonian/Re2400                      &&
#pvpython $Q2 $Newtonian/Re4000                      &&
#pvpython $Q2 $Newtonian/Re4000_impinging            



#pvpython $T_x $BirdCarreau/inlet_0p5 0.0041 0.0D &&
#pvpython $T_x $BirdCarreau/inlet0p5_impinging 0.0041 0.0D &&
#pvpython $T_x $BirdCarreau/inlet_0p3 0.0041 0.0D &&
#pvpython $T_x $BirdCarreau/inlet_0p3-a_0p5-setT_St_1 0.0041 0.0D &&
#pvpython $T_x $BirdCarreau/inlet_0p3-a_0p5-setT_St_5 0.0041 0.0D &&
#pvpython $T_x $Newtonian/Re2400 0.0041 0.0D &&
#pvpython $T_x $Newtonian/Re4000 0.0041 0.0D &&
#pvpython $T_x $Newtonian/Re4000_impinging 0.0041 0.0D &&
#echo "---------------" &&
#echo "Finish T_x 0.0D" &&
#echo "---------------" &&
#pvpython $T_x $BirdCarreau/inlet_0p5 0.006 0.25D &&
#pvpython $T_x $BirdCarreau/inlet0p5_impinging 0.006 0.25D &&
#pvpython $T_x $BirdCarreau/inlet_0p3 0.006 0.25D &&
#pvpython $T_x $BirdCarreau/inlet_0p3-a_0p5-setT_St_1 0.006 0.25D &&
#pvpython $T_x $BirdCarreau/inlet_0p3-a_0p5-setT_St_5 0.006 0.25D &&
#pvpython $T_x $Newtonian/Re2400 0.006 0.25D &&
#pvpython $T_x $Newtonian/Re4000 0.006 0.25D &&
#pvpython $T_x $Newtonian/Re4000_impinging 0.006 0.25D &&
#echo "---------------" &&
#echo "Finish T_x 0.25D" &&
#echo "---------------" &&
#pvpython $T_x $BirdCarreau/inlet_0p5 0.008 0.5D &&
#pvpython $T_x $BirdCarreau/inlet0p5_impinging 0.008 0.5D &&
#pvpython $T_x $BirdCarreau/inlet_0p3 0.008 0.5D &&
#pvpython $T_x $BirdCarreau/inlet_0p3-a_0p5-setT_St_1 0.008 0.5D &&
#pvpython $T_x $BirdCarreau/inlet_0p3-a_0p5-setT_St_5 0.008 0.5D &&
#pvpython $T_x $Newtonian/Re2400 0.008 0.5D &&
#pvpython $T_x $Newtonian/Re4000 0.008 0.5D &&
#pvpython $T_x $Newtonian/Re4000_impinging 0.008 0.5D &&
#echo "---------------" &&
#echo "Finish T_x 0.5D" &&
#echo "---------------" &&
#pvpython $T_x $BirdCarreau/inlet_0p5 0.02 2.0D &&
#pvpython $T_x $BirdCarreau/inlet0p5_impinging 0.02 2.0D &&
#pvpython $T_x $BirdCarreau/inlet_0p3 0.02 2.0D &&
#pvpython $T_x $BirdCarreau/inlet_0p3-a_0p5-setT_St_1 0.02 2.0D &&
#pvpython $T_x $BirdCarreau/inlet_0p3-a_0p5-setT_St_5 0.02 2.0D &&
#pvpython $T_x $Newtonian/Re2400 0.02 2.0D &&
#pvpython $T_x $Newtonian/Re4000 0.02 2.0D &&
#pvpython $T_x $Newtonian/Re4000_impinging 0.02 2.0D &&
#echo "---------------" &&
#echo "Finish T_x 2.0D" &&
#echo "---------------" &&
#pvpython $T_x $BirdCarreau/inlet_0p5 0.036 4.0D &&
#pvpython $T_x $BirdCarreau/inlet0p5_impinging 0.036 4.0D &&
#pvpython $T_x $BirdCarreau/inlet_0p3 0.036 4.0D &&
#pvpython $T_x $BirdCarreau/inlet_0p3-a_0p5-setT_St_1 0.036 4.0D &&
#pvpython $T_x $BirdCarreau/inlet_0p3-a_0p5-setT_St_5 0.036 4.0D &&
#pvpython $T_x $Newtonian/Re2400 0.036 4.0D &&
#pvpython $T_x $Newtonian/Re4000 0.036 4.0D &&
#pvpython $T_x $Newtonian/Re4000_impinging 0.036 4.0D &&
#echo "---------------" &&
#echo "Finish T_x 4.0D" &&
#echo "---------------" &&
#pvpython $T_x $BirdCarreau/inlet_0p5 0.052 6.0D &&
#pvpython $T_x $BirdCarreau/inlet0p5_impinging 0.052 6.0D &&
#pvpython $T_x $BirdCarreau/inlet_0p3 0.052 6.0D &&
##pvpython $T_x $BirdCarreau/inlet_0p3-a_0p5-setT_St_1 0.052 6.0D &&
##pvpython $T_x $BirdCarreau/inlet_0p3-a_0p5-setT_St_5 0.052 6.0D &&
#pvpython $T_x $Newtonian/Re2400 0.052 6.0D &&
#pvpython $T_x $Newtonian/Re4000 0.052 6.0D &&
#pvpython $T_x $Newtonian/Re4000_impinging 0.052 6.0D &&
#echo "---------------" &&
#echo "Finish T_x 6.0D" &&
#echo "---------------" &&
#pvpython $T_x $BirdCarreau/inlet_0p5 0.068 8.0D &&
#pvpython $T_x $BirdCarreau/inlet0p5_impinging 0.068 8.0D &&
#pvpython $T_x $BirdCarreau/inlet_0p3 0.068 8.0D &&
##pvpython $T_x $BirdCarreau/inlet_0p3-a_0p5-setT_St_1 0.068 8.0D &&
##pvpython $T_x $BirdCarreau/inlet_0p3-a_0p5-setT_St_5 0.068 8.0D &&
#pvpython $T_x $Newtonian/Re2400 0.068 8.0D &&
#pvpython $T_x $Newtonian/Re4000 0.068 8.0D &&
#pvpython $T_x $Newtonian/Re4000_impinging 0.068 8.0D &&
#echo "---------------" &&
#echo "Finish T_x 8.0D" &&
#echo "---------------" 
...
pvpython $Nu_x $BirdCarreau/inlet_0p5 0.0041 0.0D &&
pvpython $Nu_x $BirdCarreau/inlet0p5_impinging 0.0041 0.0D &&
pvpython $Nu_x $BirdCarreau/inlet_0p3 0.0041 0.0D &&
#pvpython $Nu_x $BirdCarreau/inlet_0p3-a_0p5-setT_St_1 0.0041 0.0D &&
#pvpython $Nu_x $BirdCarreau/inlet_0p3-a_0p5-setT_St_5 0.0041 0.0D &&
echo "---------------" &&
echo "Finish Nu_x 0.0D" &&
echo "---------------" &&
pvpython $Nu_x $BirdCarreau/inlet_0p5 0.006 0.25D &&
pvpython $Nu_x $BirdCarreau/inlet0p5_impinging 0.006 0.25D &&
pvpython $Nu_x $BirdCarreau/inlet_0p3 0.006 0.25D &&
#pvpython $Nu_x $BirdCarreau/inlet_0p3-a_0p5-setT_St_1 0.006 0.25D &&
#pvpython $Nu_x $BirdCarreau/inlet_0p3-a_0p5-setT_St_5 0.006 0.25D &&
echo "---------------" &&
echo "Finish Nu_x 0.25D" &&
echo "---------------" &&
pvpython $Nu_x $BirdCarreau/inlet_0p5                 0.0072 0.4D &&
pvpython $Nu_x $BirdCarreau/inlet0p5_impinging        0.0072 0.4D &&
pvpython $Nu_x $BirdCarreau/inlet_0p3                 0.0072 0.4D &&
#pvpython $Nu_x $BirdCarreau/inlet_0p3-a_0p5-setT_St_1 0.0072 0.4D &&
#pvpython $Nu_x $BirdCarreau/inlet_0p3-a_0p5-setT_St_5 0.0072 0.4D &&
echo "---------------" &&
echo "Finish Nu_x 0.4D" &&
echo "---------------"
pvpython $Nu_x $BirdCarreau/inlet_0p5 0.008 0.5D &&
pvpython $Nu_x $BirdCarreau/inlet0p5_impinging 0.008 0.5D &&
pvpython $Nu_x $BirdCarreau/inlet_0p3 0.008 0.5D &&
#pvpython $Nu_x $BirdCarreau/inlet_0p3-a_0p5-setT_St_1 0.008 0.5D &&
#pvpython $Nu_x $BirdCarreau/inlet_0p3-a_0p5-setT_St_5 0.008 0.5D &&
echo "---------------" &&
echo "Finish Nu_x 0.5D" &&
echo "---------------" &&
pvpython $Nu_x $BirdCarreau/inlet_0p5                 0.012 1.0D &&
pvpython $Nu_x $BirdCarreau/inlet0p5_impinging        0.012 1.0D &&
pvpython $Nu_x $BirdCarreau/inlet_0p3                 0.012 1.0D &&
#pvpython $Nu_x $BirdCarreau/inlet_0p3-a_0p5-setT_St_1 0.012 1.0D &&
#pvpython $Nu_x $BirdCarreau/inlet_0p3-a_0p5-setT_St_5 0.012 1.0D &&
echo "---------------" &&
echo "Finish Nu_x 1.0D" &&
echo "---------------" &&
pvpython $Nu_x $BirdCarreau/inlet_0p5                 0.018 1.75D &&
pvpython $Nu_x $BirdCarreau/inlet0p5_impinging        0.018 1.75D &&
pvpython $Nu_x $BirdCarreau/inlet_0p3                 0.018 1.75D &&
#pvpython $Nu_x $BirdCarreau/inlet_0p3-a_0p5-setT_St_1 0.018 1.75D &&
#pvpython $Nu_x $BirdCarreau/inlet_0p3-a_0p5-setT_St_5 0.018 1.75D &&
echo "---------------" &&
echo "Finish Nu_x 1.75D" &&
echo "---------------" 
pvpython $Nu_x $BirdCarreau/inlet_0p5 0.02 2.0D &&
pvpython $Nu_x $BirdCarreau/inlet0p5_impinging 0.02 2.0D &&
pvpython $Nu_x $BirdCarreau/inlet_0p3 0.02 2.0D &&
#pvpython $Nu_x $BirdCarreau/inlet_0p3-a_0p5-setT_St_1 0.02 2.0D &&
#pvpython $Nu_x $BirdCarreau/inlet_0p3-a_0p5-setT_St_5 0.02 2.0D &&
echo "---------------" &&
echo "Finish Nu_x 2.0D" &&
echo "---------------" &&
pvpython $Nu_x $BirdCarreau/inlet_0p5 0.036 4.0D &&
pvpython $Nu_x $BirdCarreau/inlet0p5_impinging 0.036 4.0D &&
pvpython $Nu_x $BirdCarreau/inlet_0p3 0.036 4.0D &&
#pvpython $Nu_x $BirdCarreau/inlet_0p3-a_0p5-setT_St_1 0.036 4.0D &&
#pvpython $Nu_x $BirdCarreau/inlet_0p3-a_0p5-setT_St_5 0.036 4.0D &&
echo "---------------" &&
echo "Finish Nu_x 4.0D" &&
echo "---------------" &&
pvpython $Nu_x $BirdCarreau/inlet_0p5 0.052 6.0D &&
pvpython $Nu_x $BirdCarreau/inlet0p5_impinging 0.052 6.0D &&
pvpython $Nu_x $BirdCarreau/inlet_0p3 0.052 6.0D &&
#pvpython $Nu_x $BirdCarreau/inlet_0p3-a_0p5-setT_St_1 0.052 6.0D &&
#pvpython $Nu_x $BirdCarreau/inlet_0p3-a_0p5-setT_St_5 0.052 6.0D &&
echo "---------------" &&
echo "Finish Nu_x 6.0D" &&
echo "---------------" &&
pvpython $Nu_x $BirdCarreau/inlet_0p5 0.068 8.0D &&
pvpython $Nu_x $BirdCarreau/inlet0p5_impinging 0.068 8.0D &&
pvpython $Nu_x $BirdCarreau/inlet_0p3 0.068 8.0D &&
#pvpython $Nu_x $BirdCarreau/inlet_0p3-a_0p5-setT_St_1 0.068 8.0D &&
#pvpython $Nu_x $BirdCarreau/inlet_0p3-a_0p5-setT_St_5 0.068 8.0D &&
echo "---------------" &&
echo "Finish Nu_x 8.0D" &&
echo "---------------" 
