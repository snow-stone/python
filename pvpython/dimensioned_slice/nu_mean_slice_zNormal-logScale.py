...
clip3.Value = 0.0001426658155878613
clip3.Invert = 1
clip3.Crinkleclip = 0
clip3.Exact = 0
...
nu_meanLUT.RGBPoints = [2.276146005897317e-06, 0.231373, 0.298039, 0.752941, 0.00014269399662225624, 0.865003, 0.865003, 0.865003, 0.00028311184723861516, 0.705882, 0.0156863, 0.14902]
...
nu_meanPWF.Points = [2.276146005897317e-06, 0.0, 0.5, 0.0, 0.00028311184723861516, 1.0, 0.5, 0.0]
...
ColorBy(slice1Display, ('POINTS', 'nu_mean'), True)

# Hide the scalar bar for this color map if no visible data is colored by it.
HideScalarBarIfNotNeeded(nu_meanLUT, renderView1)
...
# get separate color transfer function/color map for 'nu_mean'
separate_slice1Display_nu_meanLUT = GetColorTransferFunction('nu_mean', slice1Display, separate=True)
separate_slice1Display_nu_meanLUT.AutomaticRescaleRangeMode = "Grow and update on 'Apply'"
separate_slice1Display_nu_meanLUT.InterpretValuesAsCategories = 0
separate_slice1Display_nu_meanLUT.AnnotationsInitialized = 0
separate_slice1Display_nu_meanLUT.ShowCategoricalColorsinDataRangeOnly = 0
separate_slice1Display_nu_meanLUT.RescaleOnVisibilityChange = 0
separate_slice1Display_nu_meanLUT.EnableOpacityMapping = 0
separate_slice1Display_nu_meanLUT.RGBPoints = [2.276146005897317e-06, 0.231373, 0.298039, 0.752941, 0.00014269399662225624, 0.865003, 0.865003, 0.865003, 0.00028311184723861516, 0.705882, 0.0156863, 0.14902]
separate_slice1Display_nu_meanLUT.UseLogScale = 0
separate_slice1Display_nu_meanLUT.ColorSpace = 'Diverging'
separate_slice1Display_nu_meanLUT.UseBelowRangeColor = 0
separate_slice1Display_nu_meanLUT.BelowRangeColor = [0.0, 0.0, 0.0]
separate_slice1Display_nu_meanLUT.UseAboveRangeColor = 0
separate_slice1Display_nu_meanLUT.AboveRangeColor = [0.5, 0.5, 0.5]
separate_slice1Display_nu_meanLUT.NanColor = [1.0, 1.0, 0.0]
separate_slice1Display_nu_meanLUT.NanOpacity = 1.0
separate_slice1Display_nu_meanLUT.Discretize = 1
separate_slice1Display_nu_meanLUT.NumberOfTableValues = 256
separate_slice1Display_nu_meanLUT.ScalarRangeInitialized = 1.0
separate_slice1Display_nu_meanLUT.HSVWrap = 0
separate_slice1Display_nu_meanLUT.VectorComponent = 0
separate_slice1Display_nu_meanLUT.VectorMode = 'Magnitude'
separate_slice1Display_nu_meanLUT.AllowDuplicateScalars = 1
separate_slice1Display_nu_meanLUT.Annotations = []
separate_slice1Display_nu_meanLUT.ActiveAnnotatedValues = []
separate_slice1Display_nu_meanLUT.IndexedColors = []
separate_slice1Display_nu_meanLUT.IndexedOpacities = []

# get separate opacity transfer function/opacity map for 'nu_mean'
separate_slice1Display_nu_meanPWF = GetOpacityTransferFunction('nu_mean', slice1Display, separate=True)
separate_slice1Display_nu_meanPWF.Points = [2.276146005897317e-06, 0.0, 0.5, 0.0, 0.00028311184723861516, 1.0, 0.5, 0.0]
separate_slice1Display_nu_meanPWF.AllowDuplicateScalars = 1
separate_slice1Display_nu_meanPWF.UseLogScale = 0
separate_slice1Display_nu_meanPWF.ScalarRangeInitialized = 1

# set scalar coloring
ColorBy(slice1Display, ('POINTS', 'nu_mean'))

# Hide the scalar bar for this color map if no visible data is colored by it.
HideScalarBarIfNotNeeded(separate_slice1Display_nu_meanLUT, renderView1)
...
nu_meanLUTColorBar.Position = [0.29914364640883967, 0.17140369967355817]
nu_meanLUTColorBar.ScalarBarLength = 0.3300000000000001
