...
inlet_0p5foam.CellArrays = ['T_mean']
...
inlet_0p5foamDisplay.OSPRayScaleArray = 'T_mean'
...
inlet_0p5foamDisplay.SetScaleArray = ['POINTS', 'T_mean']
...
inlet_0p5foamDisplay.OpacityArray = ['POINTS', 'T_mean']
...
# set scalar coloring
ColorBy(inlet_0p5foamDisplay, ('POINTS', 'T_mean'))

# rescale color and/or opacity maps used to include current data range
inlet_0p5foamDisplay.RescaleTransferFunctionToDataRange(True, False)

# show color bar/color legend
inlet_0p5foamDisplay.SetScalarBarVisibility(renderView1, True)
...
t_meanLUT.RGBPoints = [-0.0481652170419693, 0.231373, 0.298039, 0.752941, 0.48919790238142014, 0.865003, 0.865003, 0.865003, 1.0265610218048096, 0.705882, 0.0156863, 0.14902]
...
t_meanPWF.Points = [-0.0481652170419693, 0.0, 0.5, 0.0, 1.0265610218048096, 1.0, 0.5, 0.0]
...
slice1Display.ColorArrayName = ['POINTS', 'T_mean']
slice1Display.DiffuseColor = [1.0, 1.0, 1.0]
slice1Display.LookupTable = t_meanLUT
...
slice1Display.ScaleFactor = 0.015999999642372132
...
slice1Display.GaussianRadius = 0.0007999999821186066
...
t_meanLUTColorBar.Position = [0.34541436464088404, 0.12570184983677934]
t_meanLUTColorBar.ScalarBarLength = 0.33000000000000007
