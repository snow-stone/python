...
inlet_0p3foam.CellArrays = ['Q', 'T', 'T_mean', 'U', 'U_mean', 'k_mean', 'k_mean_nonD', 'nu', 'nu_mean', 'p', 'reyTensor', 'reyTensor_mean', 'strainRate_U', 'tt_mean', 'vorticity_U_mean']
...
clip1.Value = 0.44817328453063965
clip1.Invert = 1
clip1.Crinkleclip = 0
clip1.Exact = 0
...
clip2.Value = 0.44817328453063965
clip2.Invert = 1
clip2.Crinkleclip = 0
clip2.Exact = 0
...
k_mean_nonDLUT.RGBPoints = [3.406558368723722e-11, 0.231373, 0.298039, 0.752941, 0.3477356136015512, 0.865003, 0.865003, 0.865003, 0.6954712271690369, 0.705882, 0.0156863, 0.14902]
...
k_mean_nonDPWF.Points = [3.406558368723722e-11, 0.0, 0.5, 0.0, 0.6954712271690369, 1.0, 0.5, 0.0]
k_mean_nonDPWF.AllowDuplicateScalars = 1
k_mean_nonDPWF.UseLogScale = 0
k_mean_nonDPWF.ScalarRangeInitialized = 1

# Rescale transfer function
k_mean_nonDLUT.RescaleTransferFunction(1e-06, 0.695471227169)

# Rescale transfer function
k_mean_nonDPWF.RescaleTransferFunction(1e-06, 0.695471227169)

# Rescale transfer function
k_mean_nonDLUT.RescaleTransferFunction(1e-06, 1.0)

# Rescale transfer function
k_mean_nonDPWF.RescaleTransferFunction(1e-06, 1.0)
...
# save screenshot
SaveScreenshot(dirName+'/k_mean_nonD_slice_yNormal_y_Eq_'+yPositionInSaveScreenShot+'.png', renderView1, ImageResolution=[2534, 1835],
