...
nu_meanLUT.RGBPoints = [2.175242798330146e-06, 0.231373, 0.298039, 0.752941, 0.0001377802221895763, 0.865003, 0.865003, 0.865003, 0.00027338520158082247, 0.705882, 0.0156863, 0.14902]
...
nu_meanPWF.Points = [2.175242798330146e-06, 0.0, 0.5, 0.0, 0.00027338520158082247, 1.0, 0.5, 0.0]
...
nu_meanLUTColorBar.Position = [0.33919889502762446, 0.034298150163220714]
nu_meanLUTColorBar.ScalarBarLength = 0.32999999999999996

# change scalar bar placement
nu_meanLUTColorBar.Position = [0.34541436464088415, 0.034298150163220714]

# Rescale transfer function
nu_meanLUT.RescaleTransferFunction(2e-06, 0.000273385201581)

# Rescale transfer function
nu_meanPWF.RescaleTransferFunction(2e-06, 0.000273385201581)
...
# change scalar bar placement
nu_meanLUTColorBar.Position = [0.3481767955801107, 0.034298150163220714]
