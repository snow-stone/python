...
inlet_0p3foam.CellArrays = ['Q', 'Q1', 'Q2', 'T', 'T_mean', 'U', 'U_mean', 'k_mean', 'k_mean_nonD', 'nu', 'nu_mean', 'p', 'reyTensor', 'reyTensor_mean', 'strainRate_U', 'tt_mean', 'vorticity_U_mean']
...
t_meanLUT = GetColorTransferFunction('nu_mean')
...
t_meanLUT.RGBPoints = [-0.029804371297359467, 0.231373, 0.298039, 0.752941, 0.4930087812244892, 0.865003, 0.865003, 0.865003, 1.015821933746338, 0.705882, 0.0156863, 0.14902]
...
t_meanPWF = GetOpacityTransferFunction('nu_mean')
t_meanPWF.Points = [-0.029804371297359467, 0.0, 0.5, 0.0, 1.015821933746338, 1.0, 0.5, 0.0]
...
# trace defaults for the display properties.
slice1Display_1.CompositeDataSetIndex = [0]
...
# export view
ExportView(dirName+'/nu_mean_slice_'+xPositionInSaveScreenShot+'_New.csv', view=spreadSheetView1)

#### saving camera placements for all active views

# current camera placement for renderView1
renderView1.CameraPosition = [0.03385640760298275, 0.0, 0.0]
renderView1.CameraFocalPoint = [0.012000000104308128, 0.0, 0.0]
...
print "Finalizing nu_mean_slice_x_labels.py " + "@ dir : " + dirName + " " + " @ " + xPositionInSaveScreenShot
import datetime
