...
inlet_0p5foam.CellArrays = ['Q', 'T', 'T_mean', 'U', 'U_mean', 'k_mean', 'nu', 'nu_mean', 'p', 'reyTensor', 'reyTensor_mean', 'vorticity_U', 'vorticity_U_mean']
...
clip3.Value = 0.00011779590863625344
clip3.Invert = 1
clip3.Crinkleclip = 0
clip3.Exact = 0
...
nu_meanLUT.RGBPoints = [2.385649850111804e-06, 0.231373, 0.298039, 0.752941, 6.110975732553925e-06, 0.865003, 0.865003, 0.865003, 9.836301614996046e-06, 0.705882, 0.0156863, 0.14902]
...
nu_meanPWF.Points = [2.385649850111804e-06, 0.0, 0.5, 0.0, 9.836301614996046e-06, 1.0, 0.5, 0.0]
...
print "Finalizing nu_mean_slice_yNormal.py " + "@ dir : " + dirName + " " + " @ " + yPositionInSaveScreenShot
import datetime
