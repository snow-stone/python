...
clip1.ClipType.Origin = [-0.012, -0.037999999010935426, 0.0]
...
clip1Display.ScaleFactor = 0.009199999831616878
...
clip1Display.GaussianRadius = 0.0004599999915808439
...
clip1Display.ScalarOpacityUnitDistance = 0.00044047509883368143
...
# init the 'Plane' selected for 'ClipType'
clip2.ClipType.Origin = [0.033999999053776264, -0.037999999010935426, 0.0]
...
# set scalar coloring
ColorBy(slice1Display, ('CELLS', 'U_mean', 'Magnitude'))
...
u_meanLUT.RGBPoints = [1.2385233950368904e-07, 0.231373, 0.298039, 0.752941, 0.8627116344485022, 0.865003, 0.865003, 0.865003, 1.7254231450446649, 0.705882, 0.0156863, 0.14902]
...
u_meanPWF.Points = [1.2385233950368904e-07, 0.0, 0.5, 0.0, 1.7254231450446649, 1.0, 0.5, 0.0]
u_meanPWF.AllowDuplicateScalars = 1
u_meanPWF.UseLogScale = 0
u_meanPWF.ScalarRangeInitialized = 1

# set scalar coloring
ColorBy(slice1Display, ('CELLS', 'U_mean', 'X'))
...
u_meanLUTColorBar.ComponentTitle = 'X'
...
print "Finalizing Ux_mean_slice_yNormal.py " + "@ dir : " + dirName + " " + " @ " + yPositionInSaveScreenShot
import datetime
