...
inlet_0p3foam.CellArrays = ['T_mean']
...
inlet_0p3foamDisplay.OSPRayScaleArray = 'T_mean'
...
inlet_0p3foamDisplay.SetScaleArray = ['POINTS', 'T_mean']
...
inlet_0p3foamDisplay.OpacityArray = ['POINTS', 'T_mean']
...
# set scalar coloring
ColorBy(slice1Display, ('CELLS', 'T_mean'))
