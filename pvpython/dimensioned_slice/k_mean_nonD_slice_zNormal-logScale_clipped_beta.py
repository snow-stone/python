...
inlet_0p3foam.CellArrays = ['Q', 'T', 'T_mean', 'U', 'U_mean', 'k_mean', 'nu', 'k_mean_nonD', 'p', 'reyTensor', 'reyTensor_mean', 'strainRate_U', 'tt_mean', 'vorticity_U_mean']
...
inlet_0p3foam.CellArrays = ['k_mean_nonD']
...
inlet_0p3foamDisplay.OSPRayScaleArray = 'k_mean_nonD'
...
inlet_0p3foamDisplay.SetScaleArray = ['POINTS', 'k_mean_nonD']
...
inlet_0p3foamDisplay.OpacityArray = ['POINTS', 'k_mean_nonD']
...
clip1.Scalars = ['POINTS', 'k_mean_nonD']
...
clip1Display.OSPRayScaleArray = 'k_mean_nonD'
...
clip2.Scalars = ['POINTS', 'k_mean_nonD']
...
clip2Display.OSPRayScaleArray = 'k_mean_nonD'
...
clip3.Scalars = ['POINTS', 'k_mean_nonD']
...
clip3Display.OSPRayScaleArray = 'k_mean_nonD'
...
clip3Display.SetScaleArray = ['POINTS', 'k_mean_nonD']
...
clip3Display.OpacityArray = ['POINTS', 'k_mean_nonD']
...
slice1Display.OSPRayScaleArray = 'k_mean_nonD'
...
# set scalar coloring
ColorBy(slice1Display, ('CELLS', 'k_mean_nonD'))
...
k_mean_nonDLUT = GetColorTransferFunction('k_mean_nonD')
k_mean_nonDLUT.AutomaticRescaleRangeMode = "Grow and update on 'Apply'"
k_mean_nonDLUT.InterpretValuesAsCategories = 0
k_mean_nonDLUT.AnnotationsInitialized = 0
k_mean_nonDLUT.ShowCategoricalColorsinDataRangeOnly = 0
k_mean_nonDLUT.RescaleOnVisibilityChange = 0
k_mean_nonDLUT.EnableOpacityMapping = 0
...
k_mean_nonDLUT.ColorSpace = 'Diverging'
k_mean_nonDLUT.UseBelowRangeColor = 0
k_mean_nonDLUT.BelowRangeColor = [0.0, 0.0, 0.0]
k_mean_nonDLUT.UseAboveRangeColor = 0
k_mean_nonDLUT.AboveRangeColor = [0.5, 0.5, 0.5]
k_mean_nonDLUT.NanColor = [1.0, 1.0, 0.0]
k_mean_nonDLUT.NanOpacity = 1.0
k_mean_nonDLUT.Discretize = 1
k_mean_nonDLUT.NumberOfTableValues = 256
k_mean_nonDLUT.ScalarRangeInitialized = 1.0
k_mean_nonDLUT.HSVWrap = 0
k_mean_nonDLUT.VectorComponent = 0
k_mean_nonDLUT.VectorMode = 'Magnitude'
k_mean_nonDLUT.AllowDuplicateScalars = 1
k_mean_nonDLUT.Annotations = []
k_mean_nonDLUT.ActiveAnnotatedValues = []
k_mean_nonDLUT.IndexedColors = []
k_mean_nonDLUT.IndexedOpacities = []

# get opacity transfer function/opacity map for 'k_mean_nonD'
k_mean_nonDPWF = GetOpacityTransferFunction('k_mean_nonD')
k_mean_nonDPWF.Points = [1e-06, 0.0, 0.5, 0.0, 1, 1.0, 0.5, 0.0]
k_mean_nonDPWF.AllowDuplicateScalars = 1
k_mean_nonDPWF.UseLogScale = 0
k_mean_nonDPWF.ScalarRangeInitialized = 1
...
k_mean_nonDLUTColorBar.AutoOrient = 1
k_mean_nonDLUTColorBar.Orientation = 'Vertical'
k_mean_nonDLUTColorBar.WindowLocation = 'LowerRightCorner'
k_mean_nonDLUTColorBar.Position = [0.89, 0.02]
k_mean_nonDLUTColorBar.Title = 'k_mean_nonD'
k_mean_nonDLUTColorBar.ComponentTitle = ''
k_mean_nonDLUTColorBar.TitleJustification = 'Centered'
k_mean_nonDLUTColorBar.HorizontalTitle = 0
k_mean_nonDLUTColorBar.TitleColor = [0.0, 0.0, 0.0]
k_mean_nonDLUTColorBar.TitleOpacity = 1.0
k_mean_nonDLUTColorBar.TitleFontFamily = 'Arial'
k_mean_nonDLUTColorBar.TitleFontFile = ''
k_mean_nonDLUTColorBar.TitleBold = 0
k_mean_nonDLUTColorBar.TitleItalic = 0
k_mean_nonDLUTColorBar.TitleShadow = 0
k_mean_nonDLUTColorBar.TitleFontSize = 16
k_mean_nonDLUTColorBar.LabelColor = [0.0, 0.0, 0.0]
k_mean_nonDLUTColorBar.LabelOpacity = 1.0
k_mean_nonDLUTColorBar.LabelFontFamily = 'Arial'
k_mean_nonDLUTColorBar.LabelFontFile = ''
k_mean_nonDLUTColorBar.LabelBold = 0
k_mean_nonDLUTColorBar.LabelItalic = 0
k_mean_nonDLUTColorBar.LabelShadow = 0
k_mean_nonDLUTColorBar.LabelFontSize = 16
k_mean_nonDLUTColorBar.AutomaticLabelFormat = 1
k_mean_nonDLUTColorBar.LabelFormat = '%-#6.3g'
k_mean_nonDLUTColorBar.DrawTickMarks = 1
k_mean_nonDLUTColorBar.DrawTickLabels = 1
k_mean_nonDLUTColorBar.UseCustomLabels = 0
k_mean_nonDLUTColorBar.CustomLabels = []
k_mean_nonDLUTColorBar.AddRangeLabels = 1
k_mean_nonDLUTColorBar.RangeLabelFormat = '%-#6.1e'
k_mean_nonDLUTColorBar.DrawAnnotations = 1
k_mean_nonDLUTColorBar.AddRangeAnnotations = 0
k_mean_nonDLUTColorBar.AutomaticAnnotations = 0
k_mean_nonDLUTColorBar.DrawNanAnnotation = 0
k_mean_nonDLUTColorBar.NanAnnotation = 'NaN'
k_mean_nonDLUTColorBar.TextPosition = 'Ticks right/top, annotations left/bottom'
k_mean_nonDLUTColorBar.ReverseLegend = 0
k_mean_nonDLUTColorBar.ScalarBarThickness = 16
k_mean_nonDLUTColorBar.ScalarBarLength = 0.33

# change scalar bar placement
k_mean_nonDLUTColorBar.Orientation = 'Horizontal'
k_mean_nonDLUTColorBar.WindowLocation = 'AnyLocation'
k_mean_nonDLUTColorBar.Position = [0.3154222573007103, 0.21374319912948847]
k_mean_nonDLUTColorBar.ScalarBarLength = 0.33000000000000007

k_mean_nonDLUTColorBar.TitleFontSize = 4
k_mean_nonDLUTColorBar.LabelFontSize = 4
k_mean_nonDLUTColorBar.ScalarBarThickness = 5
k_mean_nonDLUTColorBar.ScalarBarLength = 0.5
...
# save screenshot
SaveScreenshot(dirName+'/k_mean_nonD_slice_zNormal_z_Eq_'+zPositionInSaveScreenShot+'.png', renderView1, ImageResolution=[2534, 1835],
