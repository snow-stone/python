...
re4000foamDisplay.OSPRayScaleArray = 'k_mean'
...
re4000foamDisplay.SetScaleArray = ['POINTS', 'k_mean']
...
re4000foamDisplay.OpacityArray = ['POINTS', 'k_mean']
...
clip1.Scalars = ['POINTS', 'k_mean']
clip1.Value = 0.17633691430091858
clip1.Invert = 1
clip1.Crinkleclip = 0
clip1.Exact = 0
...
clip1Display.OSPRayScaleArray = 'k_mean'
...
clip2.Scalars = ['POINTS', 'k_mean']
clip2.Value = 0.17633691430091858
clip2.Invert = 1
clip2.Crinkleclip = 0
clip2.Exact = 0
...
clip2Display.OSPRayScaleArray = 'k_mean'
...
clip3.Scalars = ['POINTS', 'k_mean']
clip3.Value = 0.17633691430091858
clip3.Invert = 1
clip3.Crinkleclip = 0
clip3.Exact = 0
...
clip3Display.OSPRayScaleArray = 'k_mean'
...
clip3Display.SetScaleArray = ['POINTS', 'k_mean']
...
clip3Display.OpacityArray = ['POINTS', 'k_mean']
...
slice1Display.OSPRayScaleArray = 'k_mean'
...
# set scalar coloring
ColorBy(slice1Display, ('POINTS', 'k_mean'))
...
# get color transfer function/color map for 'k_mean'
k_meanLUT = GetColorTransferFunction('k_mean')
k_meanLUT.AutomaticRescaleRangeMode = "Grow and update on 'Apply'"
k_meanLUT.InterpretValuesAsCategories = 0
k_meanLUT.AnnotationsInitialized = 0
k_meanLUT.ShowCategoricalColorsinDataRangeOnly = 0
k_meanLUT.RescaleOnVisibilityChange = 0
k_meanLUT.EnableOpacityMapping = 0
k_meanLUT.RGBPoints = [0.0, 0.231373, 0.298039, 0.752941, 0.1301497220993042, 0.865003, 0.865003, 0.865003, 0.2602994441986084, 0.705882, 0.0156863, 0.14902]
k_meanLUT.UseLogScale = 0
k_meanLUT.ColorSpace = 'Diverging'
k_meanLUT.UseBelowRangeColor = 0
k_meanLUT.BelowRangeColor = [0.0, 0.0, 0.0]
k_meanLUT.UseAboveRangeColor = 0
k_meanLUT.AboveRangeColor = [0.5, 0.5, 0.5]
k_meanLUT.NanColor = [1.0, 1.0, 0.0]
k_meanLUT.NanOpacity = 1.0
k_meanLUT.Discretize = 1
k_meanLUT.NumberOfTableValues = 256
k_meanLUT.ScalarRangeInitialized = 1.0
k_meanLUT.HSVWrap = 0
k_meanLUT.VectorComponent = 0
k_meanLUT.VectorMode = 'Magnitude'
k_meanLUT.AllowDuplicateScalars = 1
k_meanLUT.Annotations = []
k_meanLUT.ActiveAnnotatedValues = []
k_meanLUT.IndexedColors = []
k_meanLUT.IndexedOpacities = []

# get opacity transfer function/opacity map for 'k_mean'
k_meanPWF = GetOpacityTransferFunction('k_mean')
k_meanPWF.Points = [0.0, 0.0, 0.5, 0.0, 0.2602994441986084, 1.0, 0.5, 0.0]
k_meanPWF.AllowDuplicateScalars = 1
k_meanPWF.UseLogScale = 0
k_meanPWF.ScalarRangeInitialized = 1
...
k_meanLUT.ApplyPreset('Yellow - Gray - Blue', True)
