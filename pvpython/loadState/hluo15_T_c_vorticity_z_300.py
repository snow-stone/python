...
# load state
LoadState(dirName+'/'+'hluo15_T_c_vorticity_z_300.pvsm', LoadStateDataFileOptions='Use File Names From State',
    DataDirectory=dirName,
    OnlyUseFilesInDataDirectory=0,
    D2NN1k_syn_forcingfoamFileName=dirName+'/'+'D2-NN-1k_syn_forcing.foam')
