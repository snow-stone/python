...
#pvpython $export_nu $Newtonian/Re2400 0.0041 0.0D &&
#pvpython $export_nu $Newtonian/Re4000 0.0041 0.0D &&
#pvpython $export_nu $Newtonian/Re4000_impinging 0.0041 0.0D &&
echo "---------------" &&
echo "Finish 0.0D" &&
echo "---------------" &&
...
#pvpython $export_nu $Newtonian/Re2400 0.006 0.25D &&
#pvpython $export_nu $Newtonian/Re4000 0.006 0.25D &&
#pvpython $export_nu $Newtonian/Re4000_impinging 0.006 0.25D &&
#echo "---------------" &&
#echo "Finish 0.25D" &&
#echo "---------------" &&
...
#pvpython $export_nu $Newtonian/Re2400 0.008 0.5D &&
#pvpython $export_nu $Newtonian/Re4000 0.008 0.5D &&
#pvpython $export_nu $Newtonian/Re4000_impinging 0.008 0.5D &&
#echo "---------------" &&
#echo "Finish 0.5D" &&
#echo "---------------"
...
#pvpython $export_nu $Newtonian/Re2400 0.02 2.0D &&
#pvpython $export_nu $Newtonian/Re4000 0.02 2.0D &&
#pvpython $export_nu $Newtonian/Re4000_impinging 0.02 2.0D &&
echo "---------------" &&
echo "Finish 2.0D" &&
echo "---------------" &&
...
#pvpython $export_nu $Newtonian/Re2400 0.036 4.0D &&
#pvpython $export_nu $Newtonian/Re4000 0.036 4.0D &&
#pvpython $export_nu $Newtonian/Re4000_impinging 0.036 4.0D &&
echo "---------------" &&
echo "Finish 4.0D" &&
echo "---------------"
...
#pvpython $export_nu $Newtonian/Re2400 0.052 6.0D &&
#pvpython $export_nu $Newtonian/Re4000 0.052 6.0D &&
#pvpython $export_nu $Newtonian/Re4000_impinging 0.052 6.0D &&
echo "---------------" &&
echo "Finish 6D" &&
echo "---------------" &&
...
#pvpython $export_nu $Newtonian/Re2400 0.068 8.0D &&
#pvpython $export_nu $Newtonian/Re4000 0.068 8.0D &&
#pvpython $export_nu $Newtonian/Re4000_impinging 0.068 8.0D &&
echo "---------------" &&
echo "Finish 8D" &&
echo "---------------"
...
#pvpython $export_nu $Newtonian/Re2400 0.076 9.0D &&
#pvpython $export_nu $Newtonian/Re4000 0.076 9.0D &&
#pvpython $export_nu $Newtonian/Re4000_impinging 0.076 9.0D &&
#echo "---------------" &&
#echo "Finish 9D" &&
#echo "---------------"
